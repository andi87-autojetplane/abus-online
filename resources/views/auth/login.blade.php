            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-muted text-center font-size-18"><b>Silahkan Masuk</b></h4>
                            ...
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group mb-0 row mt-2">
                                    ...
                                    <div class="col-sm-5 mt-3">
                                        <a href="{{ route('register') }}" class="text-muted"><i class="mdi mdi-account-circle"></i> Daftar Akun</a>
                                    </div>
                                </div>
                            </form>
                        </div>
