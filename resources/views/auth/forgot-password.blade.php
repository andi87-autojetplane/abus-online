...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Reset Password | Abus Online</title>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="p-3">
                                ...
                                Isi <strong>E-mail</strong> Anda dan anda akan mendapatkan email untuk mereset password anda!
                                ...
                                <div class="form-group pb-2 text-center row mt-3">
                                    <div class="col-12">
                                        <button class="btn btn-info w-100 waves-effect waves-light" type="submit">Kirim Email</button>
                                    </div>
                                </div>
                            </form>
                        </div>
